...
public class AddressBook {
    ...
    static HashMap<String, ContactDetails> contactList = new HashMap<String, ContactDetails>();
    ...
    public void addNewContact() throws CsvRequiredFieldEmptyException, IOException, CsvDataTypeMismatchException {
    ...
    public void updateContactDetail() throws CsvRequiredFieldEmptyException, IOException, CsvDataTypeMismatchException {
    ...
    public void deleteContact() throws CsvRequiredFieldEmptyException, IOException, CsvDataTypeMismatchException {
      ...
      //Writing the changes into CSV File
        writeAddressInToFile();
    }
    ...
    public void getUserChoice() throws CsvRequiredFieldEmptyException, IOException, CsvDataTypeMismatchException {
